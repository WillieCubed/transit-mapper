...
// modules (system.ts, catalog.ts, geo.ts) never do; serialize.ts is the one
// exception, importing only LINE_COLORS to seed a new system's default palette.
...
// ---- Palette ------------------------------------------------------------------
// Default colors offered in the color popover for a new system. Style, not domain.
